            ...
            {edit ? (
                <Card backgroundColor="#F6F6F6">
                    <form onSubmit={onSubmit}>
                        <div></div>
                        <img className={styles.img} src={newAttachment} alt="나의 식물" />
                        <input
                            type="file"
                            accept="image/*"
                            id="img-input"
                        ...
                        />
                        <label for="img-input" className={styles.uploadBtn}>
                            혹시 더 예쁜사진을 찍으셨나요~?
                        </label>
                        <MyInput
                            value={newKind}
                        ...
                        <div className={styles.editBtns}>
                            <MyButton onClick={toggleEdit} width={'145px'} backgroundColor={'var(--gray400)'}>
                                취소
                            </MyButton>
                ...
                <Card className={plant.contents}>
                    <MyButton onClick={onNewNowWaterClick} className={plant.water} width={'35px'} height={'35px'} hover={true}>
                        💧
                    </MyButton>
                    <div>
                        {PlantObj.attachmentUrl && <img src={PlantObj.attachmentUrl} width="100px" height="100px" alt="식물 이미지" />}
                        ...
                        <div className={plant.lastwaterday}>
                            <span className={plant.date}>{dateFormet}</span>에 마지막으로 물을 줬어요~🌼
                        </div>
                    </div>

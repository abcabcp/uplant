            ...
            <div className={styles.loginform}>
                <form onSubmit={onSubmit}>
                    ...
                    <MyInput
                        ...
                        fontcolor={'var(--black)'}
                    />
                    <MyInput type="submit" value={newAccount ? 'JOIN' : 'LOGIN'} backgroundColor={'var(--green)'} />
                    {error}
                </form>
                <span onClick={toggleAccount} className={`${styles.span} ${styles.span.hover}`} style={{ fontSize: '14px' }}>
                ...
                <div>
                    ...
                    <button onClick={onSocialClick} name="facebook" className={styles.social}>
                        Facebook
                    </button>
